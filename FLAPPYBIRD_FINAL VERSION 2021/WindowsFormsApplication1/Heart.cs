...
namespace WindowsFormsApplication1
{
    class Heart
    {
        ...
        public void DrawHearts(Form form, Pipe pipe)
        {
            ...
            X_Hearts = form.Width + 150 + pipe.recPipe.Width + random.Next(0, distance_2pipe);

            Y_Hearts = random.Next(0, form.Height - 90);
        ...
        public void GetHearts(Form form, Bird bird, Pipe pipe)
        {
            ...
            if (pipe.X_pipePairs1 + pipe.recPipe.Width <= 0)
            {
                ...
                if (pipes_Count == randomNext_Hearts)
                {
                    ...
                    pipes_Count = 0;
                    randomNext_Hearts = random.Next(8, 9);
                }
            }
        }
        ...
        {
            if (bird.X_Bird + bird.recBird.Width >= X_Hearts && bird.X_Bird <= X_Hearts + picBoxHearts.Width)
            {
                // increase score
